...
{
    public SortOrderValidatorAttribute() : base("VBalue must be one of the following: {0}.")
    {
    }
    ...
    protected override ValidationResult IsValid(object? value, ValidationContext validationContext)
    {
        ...
        if (!string.IsNullOrEmpty(strValue) && AllowedValues.Contains(strValue)) return ValidationResult.Success!;
